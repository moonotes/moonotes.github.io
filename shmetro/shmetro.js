...
for (var i = 1; i < 247+364+299+69+31; i++) {
...
data = [
    ...
    791.5,1058,1034,1010.8,1116,737,586,1061,1078,1088,1084,1141,759,694,1106,1090.4,1110,1108,1134.4,776,671,1107.9,1104,1097,1058.5,1115,695,627.5,1086,1087,1076.4];
var option_tmp = {
    ...
    tooltip: {
        ...
        position: function (pos, params, dom, rect, size) {
            if(size.viewSize[0]<1000){
                var obj = {top: 70};
                obj[['left', 'right'][+(pos[0] < size.viewSize[0] / 2)]] = (size.viewSize[0] / 2-100);
                return obj;
            }else{
